...
const translations = {
  en: {
    ...
    hosting_text: "This website is hosted by Mittwald CM Service GmbH & Co. KG, Königsberger Straße 4-6, 32339 Espelkamp, Germany. When you visit this website, the host automatically collects and stores various information in so-called server log files that your browser automatically transmits. For details on the host's data protection practices, please see:",
  ...
  it: {
    ...
    hosting_title: "2. Hosting",
    hosting_text: "Questo sito web è ospitato da Mittwald CM Service GmbH & Co. KG, Königsberger Straße 4-6, 32339 Espelkamp, Germania. Quando visitate questo sito web, l'host raccoglie e memorizza automaticamente varie informazioni nei cosiddetti file di log del server che il vostro browser trasmette automaticamente. Per i dettagli sulle pratiche di protezione dei dati dell'host, consultare:",
  ...
  fr: {
    ...
    hosting_text: "Ce site web est hébergé par Mittwald CM Service GmbH & Co. KG, Königsberger Straße 4-6, 32339 Espelkamp, Allemagne. Lorsque vous visitez ce site web, l'hébergeur collecte et stocke automatiquement diverses informations dans des fichiers journaux de serveur que votre navigateur transmet automatiquement. Pour plus de détails sur les pratiques de protection des données de l'hébergeur, veuillez consulter:",
        ...
        >
          ...
          <div className="prose prose-gray max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="mb-2">
                <a href="https://www.mittwald.de/datenschutz" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
